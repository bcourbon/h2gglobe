...
//  TH1F *hist_mass_sig;
  ...
  //hist_mass_sig = (TH1F*)(f->Get(var+"_cat"+category+"_ggh_m85_8TeV"))->Clone();
	cout << endl << "coucou 5" << endl;
  //hist_mass_sig->Add((TH1F*)(f->Get(var+"_cat"+category+"_vbf_m85_8TeV")));
	cout << endl << "coucou 6" << endl;
  //hist_mass_sig->Add((TH1F*)(f->Get(var+"_cat"+category+"_wzh_m85_8TeV")));
	cout << endl << "coucou 7" << endl;
  //hist_mass_sig->Add((TH1F*)(f->Get(var+"_cat"+category+"_tth_m85_8TeV")));
...
//   cout << hist_mass_dy->Integral() << endl;
  ...
  //hist_mass_data->Scale(1./hist_mass_data->Integral());
  //hist_mass_dy->Scale(1./hist_mass_dy->Integral());
  ...
  if (breakdown) {
    ...
    //leg_mass->AddEntry(hist_mass_sig,"H#rightarrow#gamma#gamma (85 GeV) #times5","F");
