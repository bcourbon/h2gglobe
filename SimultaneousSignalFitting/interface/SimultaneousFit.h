...
class SimultaneousFit {
  ...
  public:
    ...
    SimultaneousFit(string infilename, string outfilename, int mhLow=90, int mhHigh=115, int verbose=0, int nInclusiveCats=4, int nExclusiveCats=5, bool SMasBkg=true, bool SecHiggs=true, bool NatWidth=true, bool spin=false, bool splitVH=true);
    ~SimultaneousFit();
